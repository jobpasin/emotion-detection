...
path = './TrainingPicsAll'                     #Training pictures path
...
def import_images(path,path2, num_pic,emotion,img_indexes): #Process of importing images from a folder
...
def create_Eig(images,im_av,percent_Eig): #Process of creating optimal projection axis
...
Im_Av = range(4)
train_images[0],Im_Av[0] = import_images(path,path2,num_Pic,'hap',img_index)
train_images[1],Im_Av[1] = import_images(path,path2,num_Pic,'sad',img_index)
train_images[2],Im_Av[2] = import_images(path,path2,num_Pic,'ang',img_index) 
train_images[3],Im_Av[3] = import_images(path,path2,num_Pic,'sur',img_index)
...
for cnt in range(0,4):
    Eig[cnt],Eig_Val[cnt] = create_Eig(train_images[cnt],Im_Av[cnt],percent_Eig[cnt])
