...
def create_Eig(images,im_av,perc_Eig,num_Ignore): #Process of creating optimal projection axis
    ...
    return Eig,EgVal_percent[num_Ignore:num_Ignore+num_Eig],num_Eig
